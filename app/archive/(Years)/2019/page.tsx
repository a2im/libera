...
export default function Archive19({  }) {
  ...
  return (
    <div>
          <Head>Libera Awards - 2019 Archive</Head>
          <Header>Archive 2019</Header>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {Awards2019.map(Awards2019 => (
          <div key={Awards2019.id} className='category Borderswap1 p-5 flex flex-col hover:bg-libera-pink hover:text-white'>
          <motion.button 
